export async function onRequestGet({ request }) {
  return new Response(`
    ...
    <head>
      <meta charset="UTF-8">
      <title>OpenJSW 通用样式与组件库演示</title>
    ...
    <body>
      <main style="max-width:750px;margin:36px auto 48px;padding:0 20px;">
        <h1 style="margin-bottom:16px;">OpenJSW UI Kit 样式与常用组件</h1>
        <div style="color:#888;font-size:15px;">支持可访问性、响应式、暗色模式、适合现代开发的基础 UI 组件库。</div>
        
        <section class="section">
          <h2>按钮 Button</h2>
          <div class="demo-box demo-col">
            <button class="btn js-alert" data-msg="你点了主按钮！">主按钮</button>
            <button class="btn success js-alert" data-msg="操作成功！">成功按钮</button>
            <button class="btn danger js-alert" data-msg="危险操作！">危险按钮</button>
        ...
        <section class="section">
          ...
          <div class="demo-box demo-col">
            ...
            <input class="input" value="禁用" disabled>
          </div>
        ...
        <section class="section">
          <h2>语言切换器 Language Switcher</h2>
          <div class="demo-box">
            <div class="lang-switcher" tabindex="0" aria-label="切换语言">
              <span class="lang-switcher__icon" aria-hidden="true">🌏</span>
              <span class="lang-switcher__option active" data-lang="zh">简体中文</span>
              <span class="lang-switcher__option" data-lang="en">English</span>
              <div class="lang-switcher__options">
                <div class="lang-switcher__option" data-lang="zh">简体中文</div>
                <div class="lang-switcher__option" data-lang="en">English</div>
              </div>
            </div>
          </div>
        ...
        <section class="section">
          <h2>搜索组件 Search Bar</h2>
          <div class="demo-box">
            <div style="position:relative;max-width:320px;">
              <form class="search-bar" autocomplete="off" role="search">
                <span class="search-bar__icon" aria-hidden="true">🔍</span>
                <input class="search-bar__input" type="search" placeholder="搜索…" aria-label="搜索" />
              </form>
        ...
        <section class="section">
          ...
          <div style="color:#bbb;font-size:13px;">
            你可以继续拓展 Tag、分页、通知、主题切换等，所有样式与 JS 支持无障碍。
          </div>
        </section>
      </main>
